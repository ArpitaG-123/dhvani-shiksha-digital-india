      ...
      <CardContent>
        <Tabs defaultValue="video">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="video" disabled={!chapter.hasVideo}>Video</TabsTrigger>
            <TabsTrigger value="audio" disabled={!chapter.hasAudio}>Audio Summary</TabsTrigger>
            <TabsTrigger value="notes">Notes</TabsTrigger>
            <TabsTrigger value="quiz" disabled={!chapter.hasQuiz}>Quiz</TabsTrigger>
          </TabsList>
